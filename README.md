...
This validator now lives in the [Guardrails Hub monorepo](https://github.com/guardrails-ai/guardrails-hub-monorepo/tree/main/responsiveness_check/py).
**This repository is archived and no longer maintained** — please open issues and pull
requests on the monorepo instead.

```bash
pip install guardrails-ai-responsiveness-check
```
...
guard = Guard().use(ResponsivenessCheck)
```
